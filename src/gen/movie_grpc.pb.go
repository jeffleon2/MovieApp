...
type RatingServiceClient interface {
	GetAggregateRating(ctx context.Context, in *GetAggregatedRatingRequest, opts ...grpc.CallOption) (*GetAggregatedRatingResponse, error)
...
func (c *ratingServiceClient) GetAggregateRating(ctx context.Context, in *GetAggregatedRatingRequest, opts ...grpc.CallOption) (*GetAggregatedRatingResponse, error) {
	out := new(GetAggregatedRatingResponse)
	err := c.cc.Invoke(ctx, RatingService_GetAggregateRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RatingServiceServer interface {
	GetAggregateRating(context.Context, *GetAggregatedRatingRequest) (*GetAggregatedRatingResponse, error)
...
func (UnimplementedRatingServiceServer) GetAggregateRating(context.Context, *GetAggregatedRatingRequest) (*GetAggregatedRatingResponse, error) {
...
func _RatingService_GetAggregateRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).GetAggregateRating(ctx, req.(*GetAggregatedRatingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
